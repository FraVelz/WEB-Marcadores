...
export function useMarcadoresPageCommandHooks(d: MarcadoresPageDataBundle): {
  ...
  const treeToggleDisabled = d.zonesBoard || (!d.desktopWindowChrome && d.browseMode !== "folder")
  ...
  const paneBody: PaneBodyExtras = {
    ...
    deskUiByWin: d.deskUiByWin,
    updateDeskUi: d.updateDeskUi,
    toggleDeskTreeFolderCollapse: d.toggleDeskTreeFolderCollapse,
    getDeskItemRefs: d.getDeskItemRefs,
    getDeskSearchRef: d.getDeskSearchRef,
    focusDeskLibraryPane: d.focusDeskLibraryPane,
    treeToggleDisabledGlobal: d.zonesBoard || (!d.desktopWindowChrome && d.browseMode !== "folder"),
