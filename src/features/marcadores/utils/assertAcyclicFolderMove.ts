...
export const CYCLIC_FOLDER_MOVE_MESSAGE = "No se puede mover una carpeta dentro de sí misma o de sus subcarpetas"
...
export function assertAcyclicFolderMove(folders: FlatFolder[], folderId: string, destParentId: string | null): void {
