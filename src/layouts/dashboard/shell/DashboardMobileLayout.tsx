...
import { DashboardIconRail, DashboardMobileDrawer, MobileDrawerBackdrop } from "@/layouts/dashboard/sidebar"
  ...
  return (
    <>
      ...
      <div className="flex min-h-0 flex-1 flex-row overflow-hidden">
        {wide ? <DashboardIconRail /> : null}

        <div ref={dashboardFullscreenHostRef} className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
